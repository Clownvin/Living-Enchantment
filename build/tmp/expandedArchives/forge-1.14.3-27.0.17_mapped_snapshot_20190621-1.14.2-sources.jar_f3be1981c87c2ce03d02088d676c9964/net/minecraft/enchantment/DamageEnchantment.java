...
public class DamageEnchantment extends Enchantment {
   ...
   public float calcDamageByCreature(int level, CreatureAttribute creatureType) {
      ...
      } else if (this.damageType == 1 && creatureType == CreatureAttribute.field_223223_b_) {
         return (float)level * 2.5F;
      } else {
         return this.damageType == 2 && creatureType == CreatureAttribute.field_223224_c_ ? (float)level * 2.5F : 0.0F;
      }
   }
   ...
   public void onEntityDamaged(LivingEntity user, Entity target, int level) {
      if (target instanceof LivingEntity) {
         ...
         if (this.damageType == 2 && livingentity.getCreatureAttribute() == CreatureAttribute.field_223224_c_) {
