...
public abstract class MinecraftServer extends RecursiveEventLoop<TickDelayedTask> implements ISnooperInfo, ICommandSource, AutoCloseable, Runnable {
   ...
   protected void func_213194_a(SaveHandler p_213194_1_, WorldInfo info, WorldSettings p_213194_3_, IChunkStatusListener p_213194_4_) {
      ...
      ServerWorld serverworld = new ServerWorld(this, this.backgroundExecutor, p_213194_1_, info, DimensionType.field_223227_a_, this.profiler, p_213194_4_);
      this.worlds.put(DimensionType.field_223227_a_, serverworld);
      this.func_213204_a(serverworld.getSavedData());
      serverworld.getWorldBorder().copyFrom(info);
      ServerWorld serverworld1 = this.getWorld(DimensionType.field_223227_a_);
   ...
   private void applyDebugWorldInfo(WorldInfo worldInfoIn) {
      ...
      worldInfoIn.getGameRulesInstance().func_223585_a(GameRules.field_223607_j).func_223570_a(false, this);
   }
   ...
   protected void func_213186_a(IChunkStatusListener p_213186_1_) {
      ...
      ServerWorld serverworld = this.getWorld(DimensionType.field_223227_a_);
   ...
   protected void updateTimeLightAndEntities(BooleanSupplier hasTimeLeft) {
      ...
      for(ServerWorld serverworld : this.getWorlds()) {
         ...
         if (serverworld.dimension.getType() == DimensionType.field_223227_a_ || this.getAllowNether()) {
            ...
            if (this.tickCounter % 20 == 0) {
               ...
               this.playerList.sendPacketToAllPlayersInDimension(new SUpdateTimePacket(serverworld.getGameTime(), serverworld.getDayTime(), serverworld.getGameRules().func_223586_b(GameRules.field_223607_j)), serverworld.dimension.getType());
               this.profiler.endSection();
            }
   ...
   public void fillSnooper(Snooper snooper) {
      ...
      if (this.playerList != null) {
         ...
         snooper.addClientStat("players_seen", this.getWorld(DimensionType.field_223227_a_).getSaveHandler().func_215771_d().length);
      }
   ...
   public int getSpawnRadius(@Nullable ServerWorld worldIn) {
      return worldIn != null ? worldIn.getGameRules().func_223592_c(GameRules.field_223614_q) : 10;
   }
   ...
   public void reload() {
      if (!this.isOnExecutionThread()) {
         ...
         this.resourcePacks.reloadPacksFromFinders();
         this.loadDataPacks(this.getWorld(DimensionType.field_223227_a_).getWorldInfo());
   ...
   public CommandSource getCommandSource() {
      return new CommandSource(this, this.getWorld(DimensionType.field_223227_a_) == null ? Vec3d.ZERO : new Vec3d(this.getWorld(DimensionType.field_223227_a_).getSpawnPoint()), Vec2f.ZERO, this.getWorld(DimensionType.field_223227_a_), 4, "Server", new StringTextComponent("Server"), this, (Entity)null);
   }
   ...
   public GameRules getGameRules() {
      return this.getWorld(DimensionType.field_223227_a_).getGameRules();
   }
