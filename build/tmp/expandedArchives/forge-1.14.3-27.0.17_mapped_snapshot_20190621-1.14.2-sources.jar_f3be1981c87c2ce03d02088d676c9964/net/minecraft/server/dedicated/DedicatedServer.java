...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   public boolean init() throws IOException {
      ...
      if (!PreYggdrasilConverter.func_219587_e(this)) {
         ...
         if (serverproperties.announceAdvancements != null) {
            this.getGameRules().func_223585_a(GameRules.field_223620_w).func_223570_a(serverproperties.announceAdvancements, this);
         }
   ...
   public boolean isBlockProtected(World worldIn, BlockPos pos, PlayerEntity playerIn) {
      if (worldIn.dimension.getType() != DimensionType.field_223227_a_) {
         return false;
