...
public class ClientWorld extends World {
   ...
   public ClientWorld(ClientPlayNetHandler p_i51056_1_, WorldSettings p_i51056_2_, DimensionType p_i51056_3_, int p_i51056_4_, IProfiler p_i51056_5_, WorldRenderer p_i51056_6_) {
      super(new WorldInfo(p_i51056_2_, "MpServer"), p_i51056_3_, (p_217422_1_, p_217422_2_) -> {
   ...
   public void setDayTime(long time) {
      if (time < 0L) {
         time = -time;
         this.getGameRules().func_223585_a(GameRules.field_223607_j).func_223570_a(false, (MinecraftServer)null);
      } else {
         this.getGameRules().func_223585_a(GameRules.field_223607_j).func_223570_a(true, (MinecraftServer)null);
      }
