...
public class Font implements AutoCloseable {
         ...
         for(IGlyphProvider iglyphprovider1 : glyphProvidersIn) {
            ...
            if (iglyph != null) {
               ...
               if (iglyph != DefaultGlyph.INSTANCE) {
                  this.glyphsByWidth.computeIfAbsent(MathHelper.ceil(iglyph.func_223274_a_(false)), (p_212456_0_) -> {
   ...
   public TexturedGlyph obfuscate(IGlyph glyph) {
      CharList charlist = this.glyphsByWidth.get(MathHelper.ceil(glyph.func_223274_a_(false)));
