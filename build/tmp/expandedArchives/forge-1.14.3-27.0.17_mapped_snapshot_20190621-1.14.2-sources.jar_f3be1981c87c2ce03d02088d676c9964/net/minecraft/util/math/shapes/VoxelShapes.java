...
public final class VoxelShapes {
   ...
   public static VoxelShape or(VoxelShape shape1, VoxelShape shape2) {
      return combineAndSimplify(shape1, shape2, IBooleanFunction.field_223244_o_);
   }
   ...
   public static boolean doAdjacentCubeSidesFillSquare(VoxelShape shape, VoxelShape adjacentShape, Direction side) {
      if (shape != fullCube() && adjacentShape != fullCube()) {
         ...
         return !compare(fullCube(), combine(new SplitVoxelShape(voxelshape, direction$axis, voxelshape.part.getSize(direction$axis) - 1), new SplitVoxelShape(voxelshape1, direction$axis, 0), IBooleanFunction.field_223244_o_), IBooleanFunction.field_223234_e_);
      } else {
         return true;
      }
   }
   ...
   public static boolean func_223416_b(VoxelShape p_223416_0_, VoxelShape p_223416_1_) {
      if (p_223416_0_ != fullCube() && p_223416_1_ != fullCube()) {
         if (p_223416_0_.isEmpty() && p_223416_1_.isEmpty()) {
            ...
            return !compare(fullCube(), combine(p_223416_0_, p_223416_1_, IBooleanFunction.field_223244_o_), IBooleanFunction.field_223234_e_);
         }
      } else {
         return true;
      }
