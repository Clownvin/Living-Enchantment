...
public abstract class Registry<T> implements IObjectIntIterable<T> {
   ...
   @Deprecated public static final Registry<DimensionType> DIMENSION_TYPE = func_222939_a("dimension_type", net.minecraftforge.common.DimensionManager.getRegistry(), () -> {
