...
public class WorldOptimizer {
   ...
   public WorldOptimizer(String p_i50400_1_, SaveFormat p_i50400_2_, WorldInfo p_i50400_3_, boolean p_i50400_4_) {
      ...
      this.savedDataManager = new DimensionSavedDataManager(new File(DimensionType.field_223227_a_.getDirectory(this.worldStorage.getWorldDirectory()), "data"), this.worldStorage.getFixer());
