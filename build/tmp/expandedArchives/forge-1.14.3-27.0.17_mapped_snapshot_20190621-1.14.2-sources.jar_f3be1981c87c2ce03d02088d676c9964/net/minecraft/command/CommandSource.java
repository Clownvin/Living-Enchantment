...
public class CommandSource implements ISuggestionProvider {
   ...
   private void logFeedback(ITextComponent message) {
      ...
      if (this.server.getGameRules().func_223586_b(GameRules.field_223611_n)) {
      ...
      if (this.source != this.server && this.server.getGameRules().func_223586_b(GameRules.field_223608_k)) {
