...
public class FireBlock extends Block {
   ...
   public void tick(BlockState state, World worldIn, BlockPos pos, Random random) {
      if (worldIn.getGameRules().func_223586_b(GameRules.field_223598_a)) {
   ...
   public void onBlockAdded(BlockState p_220082_1_, World worldIn, BlockPos pos, BlockState p_220082_4_, boolean p_220082_5_) {
      if (p_220082_4_.getBlock() != p_220082_1_.getBlock()) {
         if (worldIn.dimension.getType() != DimensionType.field_223227_a_ && worldIn.dimension.getType() != DimensionType.field_223228_b_ || !((NetherPortalBlock)Blocks.NETHER_PORTAL).trySpawnPortal(worldIn, pos)) {
