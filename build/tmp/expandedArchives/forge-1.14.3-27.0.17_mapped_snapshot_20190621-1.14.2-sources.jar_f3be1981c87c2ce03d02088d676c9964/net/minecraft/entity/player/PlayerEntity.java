...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public void livingTick() {
      ...
      if (this.world.getDifficulty() == Difficulty.PEACEFUL && this.world.getGameRules().func_223586_b(GameRules.field_223606_i)) {
   ...
   protected void dropInventory() {
      super.dropInventory();
      if (!this.world.getGameRules().func_223586_b(GameRules.field_223600_c)) {
      ...
      if (targetEntity.canBeAttackedWithItem()) {
         if (!targetEntity.hitByEntity(this)) {
            ...
            if (targetEntity instanceof LivingEntity) {
               ...
               f1 = EnchantmentHelper.getModifierForCreature(this.getHeldItemMainhand(), CreatureAttribute.field_223222_a_);
            }
   ...
   public BlockPos getBedLocation(net.minecraft.world.dimension.DimensionType dim) {
      return dim == net.minecraft.world.dimension.DimensionType.field_223227_a_ ? spawnPos : spawnPosMap.get(dim.getRegistryName());
   }
   ...
   public boolean isSpawnForced(net.minecraft.world.dimension.DimensionType dim) {
      return dim == net.minecraft.world.dimension.DimensionType.field_223227_a_ ? spawnForced : spawnForcedMap.getOrDefault(dim.getRegistryName(), false);
   }
   ...
   protected int getExperiencePoints(PlayerEntity player) {
      if (!this.world.getGameRules().func_223586_b(GameRules.field_223600_c) && !this.isSpectator()) {
