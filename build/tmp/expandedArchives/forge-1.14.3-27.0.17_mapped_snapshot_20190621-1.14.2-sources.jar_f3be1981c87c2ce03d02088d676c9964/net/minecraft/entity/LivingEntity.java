...
public abstract class LivingEntity extends Entity {
   ...
   public boolean canBreatheUnderwater() {
      return this.getCreatureAttribute() == CreatureAttribute.field_223223_b_;
   }
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTime == 20) {
         if (!this.world.isRemote && (this.isPlayer() || this.recentlyHit > 0 && this.canDropLoot() && this.world.getGameRules().func_223586_b(GameRules.field_223602_e))) {
   ...
   public boolean isPotionApplicable(EffectInstance potioneffectIn) {
      ...
      if (this.getCreatureAttribute() == CreatureAttribute.field_223223_b_) {
   ...
   protected void spawnDrops(DamageSource p_213345_1_) {
      ...
      if (this.canDropLoot() && this.world.getGameRules().func_223586_b(GameRules.field_223602_e)) {
   ...
   protected void collideWithNearbyEntities() {
      ...
      if (!list.isEmpty()) {
         int i = this.world.getGameRules().func_223592_c(GameRules.field_223616_s);
