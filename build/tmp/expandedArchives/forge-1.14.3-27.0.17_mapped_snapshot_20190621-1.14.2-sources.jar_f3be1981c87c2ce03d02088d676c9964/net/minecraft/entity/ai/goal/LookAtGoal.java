   ...
   public boolean shouldExecute() {
      if (this.entity.getRNG().nextFloat() >= this.chance) {
         ...
         if (this.watchedClass == PlayerEntity.class) {
            this.closestEntity = this.entity.world.func_217372_a(this.field_220716_e, this.entity, this.entity.posX, this.entity.posY + (double)this.entity.getEyeHeight(), this.entity.posZ);
         } else {
            this.closestEntity = this.entity.world.func_217360_a(this.watchedClass, this.field_220716_e, this.entity, this.entity.posX, this.entity.posY + (double)this.entity.getEyeHeight(), this.entity.posZ, this.entity.getBoundingBox().grow((double)this.maxDistance, 3.0D, (double)this.maxDistance));
         }
