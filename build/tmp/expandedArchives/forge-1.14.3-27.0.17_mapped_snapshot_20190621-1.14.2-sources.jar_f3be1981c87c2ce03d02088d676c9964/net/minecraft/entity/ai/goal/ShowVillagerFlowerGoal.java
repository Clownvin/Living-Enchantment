...
public class ShowVillagerFlowerGoal extends Goal {
   ...
   public boolean shouldExecute() {
      if (!this.ironGolem.world.isDaytime()) {
         ...
         this.villager = this.ironGolem.world.func_217360_a(VillagerEntity.class, field_220738_a, this.ironGolem, this.ironGolem.posX, this.ironGolem.posY, this.ironGolem.posZ, this.ironGolem.getBoundingBox().grow(6.0D, 2.0D, 6.0D));
