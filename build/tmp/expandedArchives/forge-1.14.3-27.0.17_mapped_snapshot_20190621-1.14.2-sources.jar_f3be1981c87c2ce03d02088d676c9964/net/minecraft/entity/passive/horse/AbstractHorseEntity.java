...
public abstract class AbstractHorseEntity extends AnimalEntity implements IInventoryChangedListener, IJumpingMount {
   ...
   public boolean canBeLeashedTo(PlayerEntity player) {
      return super.canBeLeashedTo(player) && this.getCreatureAttribute() != CreatureAttribute.field_223223_b_;
   }
   ...
   protected void followMother() {
      if (this.isBreeding() && this.isChild() && !this.isEatingHaystack()) {
         LivingEntity livingentity = this.world.func_217360_a(AbstractHorseEntity.class, field_213618_bK, this, this.posX, this.posY, this.posZ, this.getBoundingBox().grow(16.0D));
