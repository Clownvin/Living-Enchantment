   ...
   class AttackPlayerGoal extends Goal {
      ...
      public boolean shouldExecute() {
         if (this.tickDelay > 0) {
            ...
            this.tickDelay = 60;
            List<PlayerEntity> list = PhantomEntity.this.world.func_217373_a(this.field_220842_b, PhantomEntity.this, PhantomEntity.this.getBoundingBox().grow(16.0D, 64.0D, 16.0D));
            if (!list.isEmpty()) {
