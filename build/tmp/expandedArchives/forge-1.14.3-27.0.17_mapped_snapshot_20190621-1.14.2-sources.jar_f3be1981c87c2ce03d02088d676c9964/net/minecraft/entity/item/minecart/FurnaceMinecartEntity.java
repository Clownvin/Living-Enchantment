...
public class FurnaceMinecartEntity extends AbstractMinecartEntity {
   ...
   public BlockState getDefaultDisplayTile() {
      return Blocks.FURNACE.getDefaultState().with(FurnaceBlock.field_220090_a, Direction.NORTH).with(FurnaceBlock.field_220091_b, Boolean.valueOf(this.isMinecartPowered()));
   }
}