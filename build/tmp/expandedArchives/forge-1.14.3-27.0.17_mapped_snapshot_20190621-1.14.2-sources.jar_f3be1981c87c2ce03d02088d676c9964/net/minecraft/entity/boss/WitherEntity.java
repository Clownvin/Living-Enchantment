...
public class WitherEntity extends MonsterEntity implements IRangedAttackMob {
   ...
   private static final Predicate<LivingEntity> NOT_UNDEAD = (p_213797_0_) -> {
      return p_213797_0_.getCreatureAttribute() != CreatureAttribute.field_223223_b_ && p_213797_0_.attackable();
   };
         ...
         for(int i = 1; i < 3; ++i) {
            if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
               ...
               if (k1 > 0) {
                  ...
                  List<LivingEntity> list = this.world.func_217374_a(LivingEntity.class, field_213798_bB, this, this.getBoundingBox().grow(20.0D, 8.0D, 20.0D));
