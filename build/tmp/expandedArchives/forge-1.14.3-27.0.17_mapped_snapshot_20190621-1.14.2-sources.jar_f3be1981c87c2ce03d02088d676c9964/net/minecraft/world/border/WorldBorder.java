...
public class WorldBorder {
   ...
   class MovingBorderInfo implements WorldBorder.IBorderInfo {
      ...
      public VoxelShape getShape() {
         return VoxelShapes.combineAndSimplify(VoxelShapes.INFINITY, VoxelShapes.create(Math.floor(this.getMinX()), Double.NEGATIVE_INFINITY, Math.floor(this.getMinZ()), Math.ceil(this.getMaxX()), Double.POSITIVE_INFINITY, Math.ceil(this.getMaxZ())), IBooleanFunction.field_223234_e_);
      }
   }
   ...
   class StationaryBorderInfo implements WorldBorder.IBorderInfo {
      ...
      private void func_212665_m() {
         ...
         this.field_222518_g = VoxelShapes.combineAndSimplify(VoxelShapes.INFINITY, VoxelShapes.create(Math.floor(this.getMinX()), Double.NEGATIVE_INFINITY, Math.floor(this.getMinZ()), Math.ceil(this.getMaxX()), Double.POSITIVE_INFINITY, Math.ceil(this.getMaxZ())), IBooleanFunction.field_223234_e_);
      }
