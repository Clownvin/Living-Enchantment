   ...
   static final class Assembler {
      ...
      public Assembler(ResourceLocation p_i50691_1_, int p_i50691_2_, JigsawManager.IPieceFactory p_i50691_3_, ChunkGenerator<?> p_i50691_4_, TemplateManager p_i50691_5_, BlockPos p_i50691_6_, List<StructurePiece> p_i50691_7_, Random p_i50691_8_) {
         ...
         if (p_i50691_2_ > 0) {
            ...
            this.field_214888_g.addLast(new JigsawManager.Entry(abstractvillagepiece, new AtomicReference<>(VoxelShapes.combineAndSimplify(VoxelShapes.create(axisalignedbb), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox)), IBooleanFunction.field_223234_e_)), k + 80, 0));
                  ...
                  for(Rotation rotation1 : Rotation.func_222467_b(this.field_214887_f)) {
                     ...
                     for(Template.BlockInfo template$blockinfo1 : list1) {
                        if (JigsawBlock.func_220171_a(template$blockinfo, template$blockinfo1)) {
                           ...
                           if (!VoxelShapes.compare(atomicreference1.get(), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox3).shrink(0.25D)), IBooleanFunction.field_223232_c_)) {
                              atomicreference1.set(VoxelShapes.combine(atomicreference1.get(), VoxelShapes.create(AxisAlignedBB.func_216363_a(mutableboundingbox3)), IBooleanFunction.field_223234_e_));
