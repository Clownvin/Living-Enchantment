      ...
      return StreamSupport.stream(new AbstractSpliterator<VoxelShape>(Long.MAX_VALUE, 1280) {
         ...
         public boolean tryAdvance(Consumer<? super VoxelShape> p_tryAdvance_1_) {
            if (!this.field_223028_a) {
               ...
               boolean flag = VoxelShapes.compare(voxelshape1, VoxelShapes.create(p_223438_1_.getBoundingBox().shrink(1.0E-7D)), IBooleanFunction.field_223238_i_);
               boolean flag1 = VoxelShapes.compare(voxelshape1, VoxelShapes.create(p_223438_1_.getBoundingBox().grow(1.0E-7D)), IBooleanFunction.field_223238_i_);
               if (!flag && flag1) {
               ...
               if (k1 != 3) {
                  ...
                  if (ichunk != null) {
                     ...
                     if ((k1 != 1 || blockstate.func_215704_f()) && (k1 != 2 || blockstate.getBlock() == Blocks.MOVING_PISTON)) {
                        ...
                        if (VoxelShapes.compare(voxelshape, voxelshape3, IBooleanFunction.field_223238_i_)) {
                           break;
                        }
                     }
                  }
