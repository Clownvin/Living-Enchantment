         ...
         if (WritableBookItem.isNBTValid(itemstack.getTag())) {
            ...
            if (itemstack.getItem() == Items.WRITABLE_BOOK && itemstack1.getItem() == Items.WRITABLE_BOOK) {
               if (packetIn.func_210345_b()) {
                  ...
                  this.player.setHeldItem(packetIn.func_212644_d(), itemstack2);
               } else {
            ...
            if (this.targetPos != null) {
               ...
               if (this.player.isPassenger()) {
                  ...
                  if (this.player.isSleeping()) {
                     ...
                     if (!this.player.isInvulnerableDimensionChange() && (!this.player.getServerWorld().getGameRules().func_223586_b(GameRules.field_223615_r) || !this.player.isElytraFlying())) {
   ...
   public void processClientStatus(CClientStatusPacket packetIn) {
      ...
      case PERFORM_RESPAWN:
         if (this.player.queuedEndExit) {
            ...
            this.player = this.server.getPlayerList().recreatePlayerEntity(this.player, DimensionType.field_223227_a_, true);
            CriteriaTriggers.CHANGED_DIMENSION.trigger(this.player, DimensionType.field_223229_c_, DimensionType.field_223227_a_);
         } else {
            ...
            if (this.server.isHardcore()) {
               ...
               this.player.getServerWorld().getGameRules().func_223585_a(GameRules.field_223613_p).func_223570_a(false, this.server);
            }
         }
         break;
      case REQUEST_STATS:
