...
public class EntityLivingXPOrb extends Entity {
    public static EntityType<EntityLivingXPOrb> livingXPOrbType;

    public static void init() {
        livingXPOrbType = /*EntityType.register("living_experience_orb", */EntityType.Builder.create(EntityLivingXPOrb.class, EntityLivingXPOrb::new).tracker(100, 1, true).build("living_experience_orb");//);
        livingXPOrbType.setRegistryName(LivingEnchantment.MODID, "living_experience_orb");
    }

    @SubscribeEvent
    public static void registerEntity(RegistryEvent.Register<EntityType<?>> event) {
        event.getRegistry().register(livingXPOrbType);
    }
    ...
    public EntityLivingXPOrb(World worldIn, double x, double y, double z, double expValue) {
        ...
        //System.out.println("Created XP Orb with EXP: "+expValue);
    }

    public EntityLivingXPOrb(World p_i1586_1_) {
        super(livingXPOrbType, p_i1586_1_);
        this.setSize(0.25F, 0.25F);
    }
    ...
    public void onCollideWithPlayer(EntityPlayer player) {
        ...
        this.remove();
        player.world.playSound(null, player.posX, player.posY, player.posZ, SoundEvents.ENTITY_PLAYER_LEVELUP, player.getSoundCategory(), Config.CLIENT.xpVolume.get().floatValue(), 0.85F + (float) (Math.random() * 0.3F));
    }
